    ...
    collection.find(query, options, function(err, cursor) {
      ...
      cursor.nextObject(function(err, doc) {
        ...
        if(doc != null) {
          ...
          self.length = 0;
          var txtId = self.fileId instanceof ObjectID ? self.fileId.toHexString() : util.inspect(self.fileId);
          return error(new Error((self.referenceBy == REFERENCE_BY_ID ? txtId : util.inspect(self.filename)) + " does not exist", self));
        }
